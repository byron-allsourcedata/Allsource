...
export const ClientLayout: React.FC<ClientLayoutProps> = ({ children }) => {
  ...
  const excludedPaths = ['/signin', '/signup', '/email-verificate', '/account-setup', '/reset-password', '/reset-password/confirm-send', '/choose-plan', '/authentication/verify-token', '/admin/users', '/admin/assets', '/forgot-password', '/admin', '/thanks-installed-app'];
