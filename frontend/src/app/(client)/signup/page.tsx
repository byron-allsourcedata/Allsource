				...
				if (response.status === 200) {
					...
					switch (responseData.status) {
						...
						case "EMAIL_ALREADY_EXISTS":
							showErrorToast(
								"Email is associated with an account. Please login",
							);
							break;
						...
						case "NOT_VALID_EMAIL":
							showErrorToast(
								"The email is either invalid or does not match the invited user.",
							);
							break;
						...
						<List sx={signupStyles.passwordContentList}>
							<ListItem sx={signupStyles.passwordContentListItem}>
								...
								<ListItemText
									sx={
										passwordValidation.length
											? signupStyles.passwordValidationTextSuccess
											: signupStyles.passwordValidationText
									}
