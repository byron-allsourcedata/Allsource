...
const SuppressionRules: React.FC = () => {
    const { suppressionHints: hints, changeSuppressionsHint } =
        useSuppressionsHints();
    ...
    const [countDeleteContacts, setCountDeleteContacts] = useState<
        number | null
    >(null);
    const [countAddedContacts, setCountAddedContacts] = useState<number | null>(
        null
    );
    ...
    const daysOptions: (string | number)[] = Array.from(
        { length: 12 },
        (_, i) => (i + 1) * 30
    );
    ...
    const handleSwitchChange = async (
        ...
        try {
            setLoading(true);
            const response = await axiosInstance.post(
                "/suppressions/collecting-contacts"
            );
        } catch (error) {
        } finally {
            setLoading(false);
    ...
    // Second switch
    const handleSwitchChangeURl = async (
        event: React.ChangeEvent<HTMLInputElement>
    ) => {
        ...
        try {
            setLoading(true);
            const response = await axiosInstance.post(
                "/suppressions/certain-activation"
            );
        } catch (error) {
        } finally {
            setLoading(false);
    ...
    const handleSwitchChangeDeleteContacts = async (
        event: React.ChangeEvent<HTMLInputElement>
    ) => {
    ...
    const handleSwitchChangeURlParameters = async (
        event: React.ChangeEvent<HTMLInputElement>
    ) => {
    ...
    const handleSubmitEmail = async () => {
        try {
            ...
            const response = await axiosInstance.post(
                "/suppressions/suppression-multiple-emails",
                {
                    data: dataToSend,
                }
            );
    ...
    const downloadFile = async () => {
        try {
            ...
            const response = await axiosInstance.get(
                "/suppressions/sample-suppression-list",
                {
                    responseType: "blob",
                }
            );
    ...
    const fetchSuppressionList = async (page: number, perPage: number) => {
        try {
            setLoading(true);
            const response = await axiosInstance.get<SuppressionListResponse>(
                "/suppressions/suppression-list",
                {
                    params: {
                        page: page + 1,
    ...
    const handleDownloadFile = async (id: number) => {
        try {
            setLoading(true);
            const response = await axiosInstance.get(
                "/suppressions/download-suppression-list",
                {
                    params: {
    ...
    const fetchRules = useCallback(async () => {
        try {
            ...
            if (typeof data.actual_contect_days !== "undefined") {
                setDays(
                    data.actual_contect_days === -1
                        ? "Eternal"
                        : data.actual_contect_days
                );
            }
    ...
    return (
        <Box>
            ...
            <Box sx={suppressionsStyles.box}>
                <Box sx={suppressionsStyles.container}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Box sx={{ pt: 0.25 }}>
                                <CustomTooltip
                                    title={
                                        "Set rules to exclude specific contacts or data from campaigns to improve targeting."
                                    }
                                    linkText="Learn more"
                                    linkUrl="https://allsourceio.zohodesk.com/portal/en/kb/articles/suppression-rules"
                                />
                            </Box>
                        </Box>
                            ...
                            >
                                ...
                                >
                                    ...
                                    {contactCount === 0
                                        ...
                                        : `Contacts suppressed till now - ${contactCount}`}
                                </Typography>
                            </Box>
                        </Box>
                    </Box>
                    <Typography
                        ...
                        sx={suppressionsStyles.subtitle}
                    >
                        Set up rules to automatically block contact collection.
                        Suppression prevents contacts from being gathered.
                    </Typography>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                You still need to manually apply the suppression
                                event to all sign-up and login forms.
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    >
                        ...
                        >
                            <Box>
                                ...
                                <Typography
                                    className="second-text"
                                    sx={{
                                        ...suppressionsStyles.dote_subtext,
                                        width: "70%",
                                    }}
                                >
                                    Once X days have passed, the contact will no
                                    longer be suppressed and will be treated as
                                    a new contact, ready for fresh engagement.
                                </Typography>
                            </Box>
                        </Box>
                        <Box
                        ...
                        >
                            ...
                            <Box sx={{ padding: 0 }}>
                                <Button
                                    variant="outlined"
                                    onClick={handleSubmitDaysContacts}
                                    sx={{
                                        backgroundColor: "#fff",
                        ...
                        >
                            <Box>
                                <Typography
                                    ...
                                    sx={suppressionsStyles.dote_text}
                                >
                                    Stop collecting contacts if you&apos;re
                                    using popup forms to gather emails.
                                </Typography>
                                <Typography
                                    className="second-text"
                                    sx={suppressionsStyles.dote_subtext}
                                >
                                    This means our suppression pixel will
                                    activate every time someone submits an email
                                    through a popup form.
                                </Typography>
                            </Box>
                            <Box
                                position="relative"
                        ...
                        >
                            <Box>
                                ...
                                <Typography
                                    ...
                                    sx={suppressionsStyles.dote_subtext}
                                >
                                    You can use either full URLs or parts of
                                    them (e.g., /shoes, /books/fantasy). If any
                                    URL includes this text, it will trigger the
                                    suppression event.
                                </Typography>
                            </Box>
                        ...
                        >
                            <TagsInput
                                ...
                                onChange={(newTags) => {
                                    const validTags =
                                        newTags.filter(isValidUrlOrPath);
                                ...
                                onBlur={(event: any) => {
                                    ...
                                    if (
                                        inputValue &&
                                        isValidUrlOrPath(inputValue) &&
                                        !chipData.includes(inputValue)
                                    ) {
                                ...
                                beforeAddValidate={(
                                    ...
                                    if (!isValidUrlOrPath(input)) {
                                        showErrorToast(
                                            "Invalid URL or part of URL. Please enter a valid value."
                                        );
                                        return false;
                                    }
                                    return true;
                        ...
                        >
                            <Box>
                                <Typography
                                    ...
                                    sx={suppressionsStyles.dote_text}
                                >
                                    Activate based on URLs with certain
                                    parameters
                                </Typography>
                                <Typography
                                    className="second-text"
                                    sx={suppressionsStyles.dote_subtext}
                                >
                                    You can use this to exclude other traffic
                                    sources or UTM identifiers (like
                                    utm_source=instagram). Any URL parameters
                                    that match this text will trigger the
                                    suppression event.
                                </Typography>
                            </Box>
                        ...
                        <Box
                            sx={{
                                display: checkedUrlParameters ? "flex" : "none",
                                flexDirection: "row",
                                justifyContent: "space-between",
                                gap: 2,
                                width: "100%",
                            ...
                            <TagsInput
                                ...
                                onBlur={(event: {
                                    ...
                                    if (
                                        inputValue &&
                                        isValidUrlOrPath(inputValue) &&
                                        !chipDataParam.includes(inputValue)
                                    ) {
                                        setChipDataParam([
                                            ...chipDataParam,
                                            inputValue,
                                ...
                                beforeAddValidate={(input: string) => {
                                    if (!isValidUrlOrPath(input)) {
                                        showErrorToast(
                                            "Invalid URL or Path. Please enter a valid value."
                                        );
                                        return false;
                                    }
                                    return true;
                ...
                >
                    <Stack direction="row">
                        ...
                        <Box position="relative">
                            {hints.rules.show && (
                                <HintCard
                                    card={suppressionsHintCards.rules}
                                    isOpenBody={hints.rules.showBody}
                                    toggleClick={() => {
                        ...
                        <TagsInput
                            ...
                            onBlur={(event: { target: { value: string } }) => {
                                ...
                                if (
                                    ...
                                    !chipDataEmail.includes(inputValue)
                                ) {
                                    setChipDataEmail([
                                        ...chipDataEmail,
                                        inputValue,
                            ...
                            beforeAddValidate={(input: string) => {
                                if (!isValidEmail(input)) {
                                    showErrorToast(
                                        "Incorrect email. Please enter a correct email."
                                    );
                                    return false;
                                }
                                return true;
            ...
            <Box sx={suppressionsStyles.box}>
                <Box sx={suppressionsStyles.container}>
                    ...
                    <Typography
                        ...
                        sx={suppressionsStyles.subtitle}
                    >
                        Upload your external contact list to avoid paying for
                        contacts you already have. There are two methods to do
                        this.
                    </Typography>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                1. Set up automatic suppression by creating an
                                integration. This will automatically update your
                                list daily, directly from your email marketing
                                program.
                            </Typography>
                            ...
                            <Box sx={suppressionsStyles.or_border}>
                                <Box
                                    sx={{
                                        width: "20%",
                                        borderBottom:
                                            "1px solid var(--Grey-lighter, rgba(220, 225, 232, 1))",
                                    }}
                                />
                                <Typography
                                    variant="body1"
                                    sx={suppressionsStyles.or_text}
                                >
                                    OR
                                </Typography>
                                <Box
                            ...
                            <Typography
                                ...
                                sx={suppressionsStyles.text}
                            >
                                2. The input must be in CSV format with a
                                header, contain only one column labeled
                                &apos;email&apos;, and be no larger than 100MB.
                            </Typography>
                            <Box
                                sx={{
                                    width: "100%",
                            ...
                            >
                                ...
                                >
                                    <Typography
                                        ...
                                        sx={suppressionsStyles.text}
                                    >
                                        • Delete these contacts from already
                                        existing audience lists
                                    </Typography>
                                    <Typography
                                        className="second-text"
                                        sx={{
                                            ...suppressionsStyles.subtitle,
                                            ml: 2,
                                            mt: 1,
                                        }}
                                    >
                                        Exclude these contacts from all
                                        previously created audiences in your
                                        account.
                                    </Typography>
                                </Box>
                                <Box
                                ...
                                >
                                    <Switch
                                        ...
                                        onChange={
                                            handleSwitchChangeDeleteContacts
                                        }
                                        sx={{
                                            width: 54,
                                            height: 24,
                                ...
                                countDeleteContacts != null && (
                                    ...
                                    >
                                        {countDeleteContacts === 0
                                            ...
                                            : `✓ ${countDeleteContacts} contact${
                                                  countDeleteContacts === 1
                                                      ? ""
                                                      : "s"
                                              } were successfully excluded from your contact list`}
                                    </Typography>
                                )}
                            {countAddedContacts != null && (
                                ...
                                >
                                    ✓ {countAddedContacts} unique contact
                                    {countAddedContacts === 1 ? "" : "s"} were
                            ...
                            >
                                ...
                                <Box sx={{ position: "relative" }}>
                                    <HintCard
                                        card={suppressionsHintCards.uploadCsv}
                                        isOpenBody={hints.uploadCsv.showBody}
                                        sx={{
                                            left: "calc(100% + 16px)",
                                            top: "calc(50% - 8px)",
                                        }}
            ...
            <Box
                sx={{
                    ...suppressionsStyles.suppressionContainer,
                    paddingLeft: 0,
                    pr: 0,
                }}
            >
                ...
                >
                    <Typography
                        className="main-text"
                        sx={{ ...suppressionsStyles.title, mb: 0 }}
                    >
                        Suppression list
                    </Typography>
                        ...
                        <Table>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell
                                        className="table-heading"
                                        sx={suppressionsStyles.tableColumn}
                                    >
                                        Date
                                    </TableCell>
                                    <TableCell
                                    ...
                                    suppressionList.map(
                                        (suppression, index) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    {
                                                        suppression.total_emails.split(
                                                            ", "
                                                        ).length
                                                    }
                                                </TableCell>
