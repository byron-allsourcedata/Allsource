...
const SuppressionRules: React.FC = () => {
	...
	const [countDeleteContacts, setCountDeleteContacts] = useState<number | null>(
		null,
	);
		...
		<Box>
			...
			<Box sx={suppressionsStyles.box}>
				<Box sx={suppressionsStyles.container}>
					...
					<Typography className="second-text" sx={suppressionsStyles.subtitle}>
						Set up rules to automatically block contact collection. Suppression
						prevents contacts from being gathered.
					</Typography>
					...
					>
						...
						>
							...
							>
								You still need to manually apply the suppression event to all
					...
					>
						...
						>
							<Box>
								...
								>
									Once X days have passed, the contact will no longer be
									suppressed and will be treated as a new contact, ready for
									fresh engagement.
								</Typography>
							</Box>
						</Box>
						...
						>
							<Box>
								<Typography
									...
									sx={suppressionsStyles.dote_text}
								>
									Stop collecting contacts if you&apos;re using popup forms to
									gather emails.
								</Typography>
								<Typography
									className="second-text"
								...
								>
									This means our suppression pixel will activate every time
									someone submits an email through a popup form.
								</Typography>
							</Box>
							<Box
								position="relative"
						...
						>
							<Box>
								...
								<Typography
									...
									sx={suppressionsStyles.dote_subtext}
								>
									You can use either full URLs or parts of them (e.g., /shoes,
									/books/fantasy). If any URL includes this text, it will
									trigger the suppression event.
								</Typography>
							</Box>
						...
						>
							<Box>
								...
								<Typography
									...
									sx={suppressionsStyles.dote_subtext}
								>
									You can use this to exclude other traffic sources or UTM
									identifiers (like utm_source=instagram). Any URL parameters
									that match this text will trigger the suppression event.
								</Typography>
							</Box>
									...
									sx={{
										...
										"& .MuiSwitch-switchBase": {
											...
											"&.Mui-checked": {
												...
												color: "#fff",
												"&+.MuiSwitch-track": {
													backgroundColor: checkedUrlParameters
														? "rgba(56, 152, 252, 1)"
														: "#7b7b7b",
						...
						<Box position="relative">
							{hints.rules.show && (
								<HintCard
									...
									toggleClick={() => {
										changeSuppressionsHint("rules", "showBody", "open");
									}}
									closeClick={() => {
										changeSuppressionsHint("rules", "showBody", "close");
									}}
									sx={{
										top: "calc(0% + 8px)",
			...
			<Box sx={suppressionsStyles.box}>
				<Box sx={suppressionsStyles.container}>
					...
					<Typography className="second-text" sx={suppressionsStyles.subtitle}>
						Upload your external contact list to avoid paying for contacts you
						already have. There are two methods to do this.
					</Typography>
					...
					>
						...
						>
							<Typography className="main-text" sx={suppressionsStyles.text}>
								1. Set up automatic suppression by creating an integration. This
								will automatically update your list daily, directly from your
							...
							<Typography className="main-text" sx={suppressionsStyles.text}>
								2. The input must be in CSV format with a header, contain only
								one column labeled &apos;email&apos;, and be no larger than
								100MB.
							</Typography>
							<Box
								sx={{
							...
							>
								...
								>
									...
									>
										Exclude these contacts from all previously created audiences
										in your account.
									</Typography>
								</Box>
								<Box
										...
										sx={{
											...
											"& .MuiSwitch-switchBase": {
												...
												"&.Mui-checked": {
													...
													color: "#fff",
													"&+.MuiSwitch-track": {
														backgroundColor: checkedDeleteContacts
															? "#5052b2"
															: "#7b7b7b",
														opacity: 1,
													},
							...
							{countAddedContacts != null && (
								...
								>
									...
									{countAddedContacts === 1 ? "" : "s"} were successfully added
							...
							>
								...
								<Box sx={{ position: "relative" }}>
									<HintCard
										...
										toggleClick={() => {
											changeSuppressionsHint("uploadCsv", "showBody", "open");
										}}
										closeClick={() => {
									...
									suppressionList.map((suppression, index) => (
										...
										>
											...
											<TableCell
												...
												sx={suppressionsStyles.tableBodyColumn}
											>
											...
											>
												...
												<IconButton
													onClick={(event) =>
														handleClickOpen(event, suppression.id)
													}
													sx={{
														":hover": {
															backgroundColor: "transparent",
