			...
			<Box sx={updatepasswordStyles.mainContent}>
				<Box sx={updatepasswordStyles.container}>
					<Typography
						...
						sx={updatepasswordStyles.title}
					>
						Change your password
					</Typography>
					<Typography
						className="second-sub-title"
						sx={updatepasswordStyles.text}
					>
						Update your password to enhance account security and maintain access
						control.
					</Typography>
					<Box
						component="form"
						onSubmit={handleSubmit}
						sx={updatepasswordStyles.form}
					>
						<TextField
							sx={updatepasswordStyles.formField}
							InputLabelProps={{
						...
						<List sx={updatepasswordStyles.passwordContentList}>
							<ListItem sx={updatepasswordStyles.passwordContentListItem}>
								<ListItemIcon
									sx={updatepasswordStyles.passwordContentListItemIcon}
								>
								...
								<ListItemText
									sx={
										passwordValidation.length
											? updatepasswordStyles.passwordValidationTextSuccess
											: updatepasswordStyles.passwordValidationText
									}
