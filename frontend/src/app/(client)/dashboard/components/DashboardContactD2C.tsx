...
const DashboardContact: React.FC<DashboardContactProps> = ({ appliedDates, typeBusiness }) => {
        ...
        const fetchData = async () => {
            try {
                ...
                setValues({
                    ...
                    total_view_products: total_view_products,
                    total_abandoned_cart: total_abandoned_cart,
                    total_converted_sale: total_converted_sale,
                    total_new_leads: 0,
                    total_page_views: 0,
                    total_returning_visitors: 0
                });
    ...
    return (
        <Box sx={{ width: '100%', '@media (max-width: 900px)': { mt: 0, mb: 2, } }}>
            <Box sx={{ width: '100%', mt: 1, mb: 1, '@media (max-width: 900px)': { mt: 0, mb: 0, } }}>
                <StatsCard
                    values={{
                        total_contacts_collected: values.total_contacts_collected,
                        total_new_leads: values.total_new_leads ?? 0,
                        total_returning_visitors: values.total_returning_visitors ?? 0,
                        total_page_views: values.total_page_views ?? 0,
                        total_visitors: values.total_visitors ?? 0,
                        total_view_products: values.total_view_products ?? 0,
                        total_abandoned_cart: values.total_abandoned_cart ?? 0,
                        total_converted_sale: values.total_converted_sale ?? 0
                    }}
