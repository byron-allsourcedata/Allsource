...
const SmartAudiencesBuilder: React.FC = () => {
	const { resetSmartsTableHints, smartsBuilderHints, changeSmartsBuilderHint } =
		useSmartsHints();
			...
			>
				...
				>
					<Skeleton
						variant="text"
						width={"12vw"}
						sx={{ fontSize: "1.75rem", alignItems: "end" }}
					/>
				</Box>
				...
				<Box sx={{ display: "flex", flexDirection: "column", width: "74%" }}>
					...
					>
							...
							<Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
								<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
									...
									<CustomTooltip
										title={"Smart Audience Builder."}
										linkText="Learn more"
										linkUrl="https://allsourceio.zohodesk.com/portal/en/kb/articles/select-your-use-case"
									/>
								</Box>
								<Typography
									sx={{
							...
							<FormControl variant="outlined">
								...
								>
									<MenuItem value="" disabled sx={{ display: "none", mt: 0 }}>
										Choose Use case Type
									</MenuItem>
									<MenuItem className="second-sub-title" value={"Meta"}>
										Meta
									</MenuItem>
									...
									<MenuItem className="second-sub-title" value={"Postal"}>
										Postal
									</MenuItem>
									<MenuItem className="second-sub-title" value={"LinkedIn"}>
										LinkedIn
									</MenuItem>
								</Select>
								{smartsBuilderHints["useCase"].show && (
									<HintCard
										...
										toggleClick={() =>
											changeSmartsBuilderHint("useCase", "showBody", "toggle")
										}
										closeClick={() =>
											changeSmartsBuilderHint("useCase", "showBody", "close")
										}
									/>
								)}
							</FormControl>
						...
						{["Google", "Bing", "Meta"].includes(useCaseType) ? (
							...
							["Email", "Tele Marketing", "Postal", "LinkedIn"].includes(
								useCaseType,
							) && (
