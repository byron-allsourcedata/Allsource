		...
		<Dialog open={open} onClose={onClose} fullWidth>
			...
			<DialogContent sx={{ padding: "20px" }}>
				<Typography
					...
					sx={{ marginBottom: 2 }}
				>
					Before you proceed, please note that validating potential leads is
					crucial for maintaining the quality of your data and ensuring
					effective communication. We strongly recommend completing the
					validation process to maximize your success.
				</Typography>
				<Typography variant="body1" className="form-input">
					Are you sure you want to skip validation?
				</Typography>
			</DialogContent>
