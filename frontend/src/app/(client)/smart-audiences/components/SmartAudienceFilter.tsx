...
const FilterPopup: React.FC<FilterPopupProps> = ({
	...
	>({});
	const [checkedFiltersUseCases, setcheckedFiltersUseCases] = useState<
		Record<string, boolean>
	>({});
				...
				>
					...
					<Box sx={filterStyles.main_filter_form}>
						...
						>
							...
							{Object.keys(checkedFiltersUseCases).some(
								(key) => checkedFiltersUseCases[key],
							) && (
								<Box
									sx={{
										display: "flex",
						...
						<Collapse in={isSmartUseCase}>
							<ExpandableCheckboxFilter
								selectedOptions={Object.keys(checkedFiltersUseCases).filter(
									(key) => checkedFiltersUseCases[key],
								)}
								allowedOptions={[
									"Meta",
