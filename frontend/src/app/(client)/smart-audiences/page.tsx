								...
								>
									...
									<MoreActionPopover
										...
										listItemButtons={[
											{
												disabled: !(
													selectedRowData?.status === "ready" ||
													selectedRowData?.status === "n_a" ||
													selectedRowData?.status === "unvalidated"
												),
												onClick: () => {
													if (
														!checkHasActivePlan({
											...
											},
											{
												disabled:
													...
													selectedRowData?.status === "validating",
												onClick: () => {
													if (
														!checkHasActivePlan({
															withoutApi: true,
									...
									<ConfirmDialogPopover
										...
										confirmAction={handleDeleteSmartAudience}
