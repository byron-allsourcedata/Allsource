...
const PartnersOverview: React.FC<PartnersOverviewProps> = ({ isMaster }) => {
	...
	const [discountCode, setDiscountCode] =
		useState<ReferralDiscountCode>(withoutDiscountCode);
	...
	const handleDiscountCodeChange = async (event: SelectChangeEvent<string>) => {
		...
		try {
			...
			const response = await axiosInstance.get(
				`referral/details?discount_code_id=${selectedCode.id}`,
			);
			setReferralLink(
				`${process.env.NEXT_PUBLIC_BASE_URL}/signup?referral=${response.data.referral_code}`,
			);
		} catch (err) {
	...
	const faqItems: FAQItem[] = !isMaster
		? [
				...
				{
					question: "2. How do I connect Stripe to get paid?",
					answer: `To connect your Stripe account and start receiving payments, follow these steps:
				...
				{
					question: "3. How do I invite users to sign up?",
					answer: `To invite users to sign up, follow these steps:
				...
				{
					question: "4. How do I see my sign-ups?",
					answer: `To view the users who signed up using your referral link, follow these steps:
				...
				{
					question: "5. How do I see my commission?",
					answer: `To view your commission, follow these steps:
				...
				{
					question: "6. When do I get paid?",
					answer: `Referral rewards are distributed in the first week of the following month.`,
				},
			]
		: [
				{
				...
				{
					question: "6. How do I invite a partner?",
					answer: `To invite a partner, follow these steps:
				...
				{
					question: "7. How do I set up the partner's commission?",
					answer: `There are two ways to set up a partner's commission:
								...
								<>
									...
									>
										...
										{stripeEmail && (
											...
											>
												<Typography className="table-heading">Email</Typography>
								...
								<>
									...
									>
										...
										>
											...
											{currentDue && (
												<Box
													sx={{ display: "flex", alignItems: "start", pr: 2 }}
												>
													<Tooltip
														title={
															<Box>
										...
										>
											...
											>
												Referral details are unavailable. Update your
