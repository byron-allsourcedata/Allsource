...
const MonthDetails: React.FC<MonthDetailsProps> = ({
	...
	const tableHeaders = [
		...
		{
			key: "plan_amount",
			label: partnerTab ? "Partner reward" : "Plan amount",
			sortable: false,
		},
					...
					<Box sx={{ display: "flex" }}>
						...
						>
							<Table>
										...
										{tableHeaders.map(({ key, label, sortable }) => (
											...
											>
												...
												>
													...
													{tabIndex === 1 && label === "Partner reward" && (
														<Box
															sx={{
																"@media (max-width: 600px)": {
																	display: "none",
													...
													{tabIndex === 1 && label === "Payout amount" && (
														<Box
															sx={{
																"@media (max-width: 600px)": {
																	display: "none",
								...
								<TableBody>
									{data && data.length === 0 ? (
										<TableRow sx={partnersStyle.tableBodyRow}>
											<TableCell
												colSpan={9}
												sx={{
										...
										data.map((item, index) => (
											...
											>
												...
												<TableCell
													...
													sx={partnersStyle.tableBodyColumn}
												>
													{item.email}
												</TableCell>
												...
												>
													<Typography
														component="span"
														sx={{
															background: getStatusStyle(item.reward_status)
																.background,
															padding: "6px 8px",
															borderRadius: "2px",
															fontFamily: "Roboto",
												...
												>
													{item.is_auto_payout_date ? (
														<>
															...
															{dayjs(item.reward_payout_date).format(
																"MMM D, YYYY",
															)}
														</>
													) : (
