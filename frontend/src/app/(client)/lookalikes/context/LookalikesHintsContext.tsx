...
const LookalikeHintsContext = createContext<HintsContextType | undefined>(
	undefined,
);

export const LookalikeHintsProvider: React.FC<HintsProviderProps> = ({
	children,
}) => {
	const [lookalikesBuilderHints, setSourcesBuilderHints] = useState<
		HintStateMap<BuilderKey>
	>(initialSourcesBuilderHints);
	const [lookalikesTableHints, setLookalikesTableHints] = useState<
