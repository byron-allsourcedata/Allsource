...
import type { CalculationResponse, RecommendedByCategory } from "@/types";
		...
		>
			<Grid container sx={{ mb: 2 }}>
				<Grid item xs={7}>
					...
					>
						You can configure the predictable fields that will be used for
						audience building yourself.
					</Typography>
					{!canProceed && (
						<Typography
							variant="body2"
			...
			<Grid container sx={{ mb: 2 }}>
				...
				<Grid
					item
					sx={{ flexGrow: 1, borderBottom: "1px solid rgba(233, 233, 233, 1)" }}
				></Grid>
			</Grid>
						...
						<>
							<Box sx={{ mb: 2, position: "relative" }}>
								<FeatureImportanceTable
									...
									features={
										calculatedResults.audience_feature_importance_b2c.personal
									}
							...
							<Box sx={{ mb: 2 }}>
								<FeatureImportanceTable
									title="Financial"
									features={
										calculatedResults.audience_feature_importance_b2c.financial
									}
							...
							<Box sx={{ mb: 2 }}>
								<FeatureImportanceTable
									title="Lifestyles"
									features={
										calculatedResults.audience_feature_importance_b2c.lifestyle
									}
							...
							<Box sx={{ mb: 2 }}>
								<FeatureImportanceTable
									title="Voter"
									features={
										calculatedResults.audience_feature_importance_b2c.voter
									}
							...
							<Box sx={{ mb: 2 }}>
								<FeatureImportanceTable
									...
									features={
										calculatedResults.audience_feature_importance_b2b
											.professional_profile
									}
				...
				<Grid item xs={12} md={5} sx={{ flexGrow: 1 }}>
					<Box sx={{ p: 0, bgcolor: "transparent" }}>
						...
						>
							...
							predictable fields you want to use based on your specific goals.
							These fields might include things like age, location, interests,
							purchase behavior, or other relevant data points that help define
