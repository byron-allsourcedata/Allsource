                        ...
                        <TableRow key={index}>
                                    ...
                                    <Tooltip
                                        title={
                                            <Box sx={{ backgroundColor: '#fff', margin: 0, padding: 0, display: 'flex', flexDirection: 'row', alignItems: 'center', }}>
                                                <Typography className='table-data' component='div' sx={{ fontSize: '.75rem !important', }}>
                                        ...
                                        componentsProps={{
                                            tooltip: {
                                                sx: {
                                                    backgroundColor: '#fff',
                                                    color: '#000',
                                                    boxShadow: '0rem .25rem .25rem 0rem rgba(0, 0, 0, 0.12)',
                            ...
                            <TableCell>
                                {(() => {
                                    ...
                                    return size ? `${setSourceType(size.label)} ${size.min_value}-${size.max_value}%` : row.lookalike_size;
                                })()}
                            </TableCell>
