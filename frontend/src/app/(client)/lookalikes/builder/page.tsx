                                        ...
                                        <Box sx={{ display: 'flex', width: '100%', flexDirection: 'column', pt: 2, gap: 2 }}>
                                            <Box sx={{ width: "100%" }}>
                                                <TextField
                                                    ...
                                                    value={search}
                                                    onChange={(e) => { setSearch(e.target.value), setIsTableVisible(true) }}
                                                    InputProps={{
                                                        startAdornment: (
                                                        ...
                                                        <Table>
                                                            <TableHead>
                                                                <TableRow sx={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
                                                                    <TableCell className="black-table-data" sx={{ flex: 1, textAlign: "start" }}>Name</TableCell>
                                                                    <TableCell className="black-table-data" sx={{ flex: 1, textAlign: "start" }}>Type</TableCell>
                                                                    <TableCell className="black-table-data" sx={{ flex: 1, textAlign: "end" }}>Size</TableCell>
                                                                </TableRow>
                                                            </TableHead>
                                                            <TableBody>
                                                                {filteredData.map((row) => (
                                                                    <TableRow key={row.name} hover sx={{ cursor: "pointer", display: "flex", justifyContent: "space-between", width: "100%" }} onClick={() => handleSelectRow(row)}>
                                                                        <TableCell className="black-table-header" sx={{ flex: 1, textAlign: "start" }}>{row.name}</TableCell>
                                                                        <TableCell className="black-table-header" sx={{ flex: 1, textAlign: "start" }}>{toNormalText(row.type)}</TableCell>
                                                                        <TableCell className="black-table-header" sx={{ flex: 1, textAlign: "right" }}>{row.matched_records}</TableCell>
                                                                    </TableRow>
                                                                ))}
                                                            </TableBody>
