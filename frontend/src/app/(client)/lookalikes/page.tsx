							...
							<Box sx={{ width: "100%" }}>
								<FirstTimeScreenCommonVariant1
										...
										<>
											<BuilderIntro
												...
												previewProps={{
													...
													headerTitle:
														"Grow Your Audience with AI-Powered Lookalikes",
													caption:
									...
									LeftMenu={{
										...
										subtitle:
											"30-minute consultation on audience modeling best practices",
										image: {
										...
										items: [
											...
											},
											{
												...
												title: "Advanced Scaling Strategies",
												subtitle:
													"Turn your high-performers into scalable growth engines with AI",
											},
										],
									}}
									ContentStyleSX={{
