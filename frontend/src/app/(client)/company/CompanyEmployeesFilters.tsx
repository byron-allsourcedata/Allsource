...
const CompanyFilterPopup: React.FC<FilterPopupProps> = ({
	...
	// Industry
	const [checkedFiltersSeniority, setCheckedFiltersSeniority] = useState<
		Record<string, boolean>
	>({});
	const [checkedFiltersJobTitles, setCheckedFiltersJobTitles] = useState<
		Record<string, boolean>
	>({});
	const [checkedFiltersDepartment, setCheckedFiltersDepartment] = useState<
		Record<string, boolean>
	>({});
	...
	useEffect(() => {
		if (open) {
			if (departments) {
				const initialState = departments.reduce(
					(acc, item) => {
						acc[item] = false;
						return acc;
					},
			...
			if (seniorities) {
				const initialState = seniorities.reduce(
					(acc, item) => {
						acc[item] = false;
						return acc;
					},
			...
			if (jobTitles) {
				const initialState = jobTitles.reduce(
					(acc, item) => {
						acc[item] = false;
						return acc;
					},
					...
					<Box sx={filterStyles.main_filter_form}>
						...
						>
							...
							<WorkOutlineOutlinedIcon
								...
								height={18}
							/>
							<Typography sx={filterStyles.filter_name}>Job Title</Typography>
							<IconButton
								onClick={() => setIsJobTitleOpen(!isJobTitleOpen)}
						...
						{Object.keys(checkedFiltersJobTitles).some(
						...
						<Collapse in={isJobTitleOpen}>
							<Box
								sx={{
									...
									height: openSelectJobTitle ? 250 : 50,
								}}
							>
													...
													<ListItemText sx={{}}>
														<Typography
															sx={{
																...
																fontWeight: 500,
																lineHeight: "19.6px",
																color: checkedFiltersJobTitles[item]
																	? "rgba(56, 152, 252, 1)"
																	: "rgba(32, 33, 36, 1)",
															}}
														>
					...
					<Box sx={filterStyles.main_filter_form}>
						...
						>
							...
							<LineWeightIcon
								...
								height={18}
							/>
							<Typography sx={filterStyles.filter_name}>Seniority</Typography>
							<IconButton
								onClick={() => setIsSeniorityOpen(!isSeniorityOpen)}
								aria-label="toggle-content"
							>
						...
						{Object.keys(checkedFiltersSeniority).some(
						...
						<Collapse in={isSeniorityOpen}>
							<Box
								sx={{
									...filterStyles.filter_dropdown,
									height: openSelectSeniority ? 250 : 50,
								}}
							>
													...
													<ListItemText sx={{}}>
														<Typography
															sx={{
																...
																fontWeight: 500,
																lineHeight: "19.6px",
																color: checkedFiltersSeniority[item]
																	? "rgba(56, 152, 252, 1)"
																	: "rgba(32, 33, 36, 1)",
															}}
														>
					...
					<Box sx={filterStyles.main_filter_form}>
						...
						>
							...
							<TimelineIcon
								...
								height={18}
							/>
							<Typography sx={filterStyles.filter_name}>Department</Typography>
							<IconButton
								onClick={() => setIsDepartmentOpen(!isDepartmentOpen)}
								aria-label="toggle-content"
							>
						...
						{Object.keys(checkedFiltersDepartment).some(
						...
						<Collapse in={isDepartmentOpen}>
							<Box
								sx={{
									...filterStyles.filter_dropdown,
									height: openSelectDepartment ? 250 : 50,
								}}
							>
													...
													<ListItemText sx={{}}>
														<Typography
															sx={{
																...
																fontWeight: 500,
																lineHeight: "19.6px",
																color: checkedFiltersDepartment[item]
																	? "rgba(56, 152, 252, 1)"
																	: "rgba(32, 33, 36, 1)",
															}}
														>
