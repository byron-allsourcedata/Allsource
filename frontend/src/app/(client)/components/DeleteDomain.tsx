		...
		<>
			...
			>
				<Box p={4}>
					...
					>
						Are you sure you want to remove this domain? If you do, all data
					...
					>
						To delete the domain, you need to enter{" "}
						<strong>
							{domain.domain
								.replace(/^https?:\/\/(www\.)?/, "")
								.replace(/\/$/, "")}
						</strong>{" "}
						in the field below and press the &apos;Remove&apos; button.
					</Typography>
				</Box>
				<Box sx={{ flexGrow: 1, display: "flex", justifyContent: "center" }}>
					<TextField
						...
						value={
							isFocused
								? enterDomain.replace(/^https?:\/\//, "")
								: `https://${enterDomain.replace(/^https?:\/\//, "")}`
						}
