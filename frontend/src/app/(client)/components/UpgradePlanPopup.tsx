...
export const UpgradePlanPopup: React.FC<Props> = ({
  open,
  handleClose,
  limitName,
}) => {
          ...
          >
            ...
            <Box sx={{ paddingRight: 2, paddingLeft: 2 }}>
              <Typography
                ...
                variant="h6"
              >
                You have reached the maximum {limitName} limit for your current
                plan. To add more {limitName}, please consider upgrading your
                plan.
              </Typography>
              <Typography
                className="paragraph"
