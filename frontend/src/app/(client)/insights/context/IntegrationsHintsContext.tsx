...
const InsightsHintsContext = createContext<
	InsightsHintsContextType | undefined
>(undefined);

export const InsightsHintsProvider: React.FC<{ children: ReactNode }> = ({
	children,
}) => {
	const [insightsHints, setInsightsHints] = useState<
		HintStateMap<InsightsBuilderKey>
	>(initialInsightsBuilderHints);
