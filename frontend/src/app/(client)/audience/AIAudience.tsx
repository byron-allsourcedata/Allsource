...
const audienceSize = [
  {
    ...
    text: "Lookalike size: 10K contacts",
    min_value: 10,
    max_value: 10,
  },
  {
    ...
    text: "Lookalike size: 50K contacts",
    min_value: 10,
    max_value: 10,
  },
  {
    id: "very",
    label: "Very similar",
    text: "Lookalike size: 100K contacts",
    min_value: 7,
    max_value: 10,
  },
  {
    id: "quite",
    label: "Quite similar",
    text: "Lookalike size: 200K contacts",
    min_value: 10,
    max_value: 15,
  },
  {
    id: "broad",
    label: "Broad",
    text: "Lookalike size: 500K contacts",
    min_value: 15,
    max_value: 20,
  },
];
...
const AIAudience: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  const [selectedType, setSelectedType] = useState<string[]>(
    audienceType.map((source) => source.id)
  );
        ...
        <Box sx={{ width: "90%" }}>
          ...
          >
            <Button
              onClick={onBack}
              className="button"
              sx={{ textTransform: "none", pt: 0, pb: 0, pl: 0 }}
            >
                ...
                >
                  ...
                  <Box>
                    <Typography className="table-data">
                      {" "}
                      Leverage Maximiz AI audience to identify key traits and
                      deliver high-intent audience lookalikes from your data.{" "}
                    </Typography>
                  </Box>
                </Box>
              </Box>
                    ...
                    {dataSources.map((source) => (
                      ...
                      >
                        ...
                        <Box
                          sx={{
                            visibility:
                              selectedSource === source.id ? "" : "hidden",
                            display: "flex",
                            alignItems: "center",
                          }}
                        >
                          <Image
                            src="lightgreen-tick-circle.svg"
                            alt="Ok"
                            width={20}
                            height={20}
                          />
                      ...
                      >
                        ...
                        <Button
                          ...
                          sx={{
                            ...
                            alignItems: "center",
                            justifyContent: "space-between",
                            border: selectedType.includes(source.id)
                              ? "1px solid rgba(117, 168, 218, 1)"
                              : "1px solid rgba(208, 213, 221, 1)",
                            padding: "0.6rem 0.5rem",
                            borderRadius: "4px",
                            textTransform: "none",
                            backgroundColor: selectedType.includes(source.id)
                              ? "rgba(246, 248, 250, 1)"
                              : "transparent",
                            width: "100%",
                          }}
