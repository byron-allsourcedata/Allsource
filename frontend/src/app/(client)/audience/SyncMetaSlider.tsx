								...
								>
									...
									>
										...
										>
											...
											<CustomTooltip
												title={
													"New audiences become available each Monday and are automatically synced to your integrated platform"
												}
											/>
										</Box>
												...
												<Box>
													<TextField
														...
														label={
															selectedOption
																? ""
																: "Select or Create custom audience list"
														}
														InputLabelProps={{
													...
													>
														...
														{/* Show static options */}
														{metaAuidence &&
															metaAuidence.map((klaviyo, option) => (
																<MenuItem
																	key={klaviyo.id}
