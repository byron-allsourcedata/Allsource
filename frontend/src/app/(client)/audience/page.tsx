    ...
    <Box sx={audienceStyles.mainContent}>
      <Box
        sx={{
          ...
          alignItems: "center",
          position: "fixed",
          top: hasNotification ? "7.05rem" : "4.25rem",
          pt: "20px",
          pb: "16px",
          left: "9.1rem",
          zIndex: 1200,
          ...
          width: "100%",
          ml: 0,
          "@media (max-width: 900px)": { left: 0, zIndex: 50 },
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      ...
                      sx={{ fontWeight: "700 !important", pt: "20px" }}
                    >
                      AI Audience
                    </Typography>
                    <Typography
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      className="table-data"
                      sx={{ textAlign: "left", pt: "6px", opacity: 0.65 }}
                    >
                      Prompt Our AI and Discover the Ideal Audience for Your
                      Needs
                    </Typography>
                  </Box>
                </Button>
            ...
            <Box sx={{ pt: "2rem", pr: "32px" }}>
              ...
              >
                ...
                >
                  ...
                  <Typography
                    className="table-data"
                    sx={{ textAlign: "center", pt: "18px" }}
                  >
                    Supercharge your ad campaigns with high-performing
                    lookalikes. Target those most likely to purchase, <br />
                    optimize your ad spend, and scale your profitability like
                    never before.
                  </Typography>
                </Box>
              </Box>
