...
import { useSourcesHints } from "@/app/\(client)\/sources/context/SourcesHintsContext";
import { builderHintCards } from "@/app/\(client)\/sources/context/hintsCardsContent";
...
const SourcesImport: React.FC<{ hideTitle?: boolean }> = ({ hideTitle }) => {
