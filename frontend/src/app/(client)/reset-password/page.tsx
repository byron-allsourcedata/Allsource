			...
			<Box sx={resetStyles.mainContent}>
				<Box sx={resetStyles.container}>
					<Typography
						...
						sx={resetStyles.title}
					>
						Forgot your password?
					</Typography>
					<Typography className="second-sub-title" sx={resetStyles.text}>
						No worries! Let&apos;s get you back on track soon. Enter your email,
						and we will send you instructions to recover your password.
					</Typography>
					<Box component="form" onSubmit={handleSubmit} sx={resetStyles.form}>
						<TextField
							sx={resetStyles.formField}
							InputLabelProps={{
