...
const TotalLeadsCard: React.FC<{ value: number; typeBusiness: string }> = ({
	value,
	typeBusiness,
}) => (
	<StatCard
		...
		icon={
			<MarkEmailReadOutlinedIcon
				sx={{ color: "rgba(244, 87, 69, 1)", fontSize: "36px" }}
			/>
		}
...
const NewCustomersCard: React.FC<{ value: number; typeBusiness: string }> = ({
	value,
	typeBusiness,
}) => (
	<StatCard
...
const DemographicsCard: React.FC<{ value: number; typeBusiness: string }> = ({
	value,
	typeBusiness,
}) => (
	<StatCard
		...
		imageUrl={
			typeBusiness === "d2c" ? "/PersonEdit.svg" : "/returning_visitors.svg"
		}
		textColor="rgba(74, 74, 74, 1)"
...
const AbandonedCart: React.FC<{ value: number; typeBusiness: string }> = ({
	value,
	typeBusiness,
}) => (
	<StatCard
...
const SalesOverTimeCard: React.FC<{ value: number; typeBusiness: string }> = ({
	value,
	typeBusiness,
}) => (
	<StatCard
			...
			{typeBusiness === "d2c" ? (
				<>
					<Grid item xs={12} md={2.4}>
						<TotalLeadsCard
							value={values.total_contacts_collected ?? 0}
							typeBusiness={typeBusiness}
						/>
					</Grid>
					<Grid item xs={12} md={2.4}>
						<NewCustomersCard
							value={values.total_visitors ?? 0}
							typeBusiness={typeBusiness}
						/>
					</Grid>
					<Grid item xs={12} md={2.4}>
						<DemographicsCard
							value={values.total_view_products ?? 0}
							typeBusiness={typeBusiness}
						/>
					</Grid>
					<Grid item xs={12} md={2.4}>
						<AbandonedCart
							value={values.total_abandoned_cart ?? 0}
							typeBusiness={typeBusiness}
						/>
					</Grid>
					<Grid item xs={12} md={2.4}>
						<SalesOverTimeCard
							value={values.total_converted_sale ?? 0}
							typeBusiness={typeBusiness}
						/>
					</Grid>
				</>
