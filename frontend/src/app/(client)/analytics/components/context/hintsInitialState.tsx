...
const initialDomainSelectorHints: Record<
	keyof typeof domainSelectorHintCards,
	StateHint
> = {
...
const initialPixelInstallationHints: Record<
	keyof typeof pixelInstallationHintCards,
	StateHint
> = {
	chooseInstallationMethod: { show: true, showBody: true, id: 0 },
};

const initialVerifyPixelIntegrationHints: Record<
	VerifyPixelIntegrationKey,
	StateHint
> = {
