...
const tableData = [
    ...
    // Можно добавить другие строки таблицы по аналогии
];
...
const CreateLookalikePage: React.FC = () => {
    ...
    const handleGenerateClick = () => {
        if (inputText.trim() !== "") {
            setIsLookalikeGenerated(true); // Переключаем на новый компонент
        }
    };
                        ...
                        >
                            ...
                            >
                                ...
                                <Typography className="paragraph">
                                    Fine-tune your targeting! Choose the size of
                                    your lookalike audience to match your
                                    marketing goals.
                                </Typography>
                                        ...
                                        >
                                            ...
                                            <Button
                                                ...
                                                sx={{
                                                    ...
                                                    borderRadius: "4px",
                                                    textTransform: "none",
                                                    width: "100%", // Каждая кнопка будет занимать всю ширину доступного пространства
                                                }}
                                            >
                                                <Box
                                                    sx={{
