																...
																{eventCards.sources.map((card, index) => (
																	<Box key={index} mt={1}>
																		<MainSectionCard
																			key={card.id}
																			data={card}
																			highlighted={activeChainIds.includes(
																				card.id,
																			)}
																			onClick={() => {
																	...
																	(card, index) => (
																		<Box key={index} mt={1}>
																			<SmartAudienceCard
																				...
																				onClick={() => {
																					if (
																						activeChainIds.includes(card.id)
																					) {
																						setActiveChainIds([]);
																					} else {
																						setActiveChainIds(card.chain_ids);
							...
							<>
								<FirstTimeScreenCommonVariant1
										...
										<CardsSection
											items={[
												...
												},
												{
													title: "Import Source from CSV file",
													subtitle:
														"Alternatively, you can upload a CSV file containing your existing customer data.",
									...
									HelpCard={{
										...
										description:
											"Book a free 30-minute call and get personalized help with platform navigation, analytics, or any dashboard issues.",
										helpPoints: [
											{
									...
									LeftMenu={{
										...
										items: [
											...
											},
											{
												...
												title: "Data Analysis Help",
												subtitle:
													"Go beyond numbers – learn how to extract insights tailored to your goals.",
											},
											{
												Icon: MovingIcon,
												title: "Troubleshooting",
												subtitle:
													"Fix glitches fast and ensure your data flows accurately.",
											},
										],
									}}
									ContentStyleSX={{
