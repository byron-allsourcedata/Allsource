...
const FilterPopup: React.FC<FilterPopupProps> = ({
	...
	const handleChangeRecurringVisits = (
	...
	const handleDeleteTimeSpent = (valueToDelete: string) => {
		setSelectedTags((prevTags) => {
			const updatedTags = prevTags.timeSpents.filter(
				(tag) => tag !== valueToDelete,
			);
	...
	const handleTimeChange = (name: string) => (newValue: any) => {
		setTimeRange((prevRange) => {
			...
			setCheckedFiltersTime((prevFiltersTime) => {
				...
				const previouslySelectedTime = Object.keys(prevFiltersTimeTyped).find(
					(key) => prevFiltersTimeTyped[key],
				);
			...
			const fromTime = updatedRange.fromTime
				? dayjs(updatedRange.fromTime).format("h:mm A")
				: "";
			const toTime = updatedRange.toTime
				? dayjs(updatedRange.toTime).format("h:mm A")
				: "";
	...
	const handleFilters = () => {
		...
		let fromTime = timeRange.fromTime
			? dayjs(timeRange.fromTime).format("HH:mm")
			: null;
	...
	const initializeFilters = () => {
		...
		if (savedFilters) {
			...
			if (isTimeFilterActive) {
				...
				const fromTime = savedFilters.from_time
					? dayjs(savedFilters.from_time, "HH:mm")
					: null;
				const toTime = savedFilters.to_time
					? dayjs(savedFilters.to_time, "HH:mm")
					: null;
				...
				>
									...
									<FormControlLabel
										...
										label={
											<Typography
												className="table-data"
												sx={{
													...filterStyles.collapse_font,
													color: checkedFiltersTime.morning
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												...
												sx={{
													...filterStyles.collapse_font,
													color: checkedFiltersTime.evening
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												...
												sx={{
													...filterStyles.collapse_font,
													color: checkedFiltersTime.afternoon
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												...
												sx={{
													...filterStyles.collapse_font,
													color: checkedFiltersTime.all_day
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
					...
					<Box sx={filterStyles.main_filter_form}>
						...
						>
							...
							/>
							<Image src="/url.svg" alt="url" width={18} height={18} />
							<Typography
								sx={{
									...filterStyles.filter_name,
									whiteSpace: "nowrap",
						...
						<Collapse in={isPageUrlOpen}>
							...
							{pageUrls.map((data, index) => (
								<ListItem
									button
									key={index}
									onClick={() => handleSelectPageUrl(data)}
								>
									<ListItemText
										primary={
											<span
									...
									<FormControlLabel
										...
										label={
											<Typography
												className="table-data"
												sx={{
													color: checkedFiltersPageVisits.three_page
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												className="table-data"
												sx={{
													color: checkedFiltersPageVisits.more_three
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												className="table-data"
												sx={{
													color: checkedFiltersTimeSpent.under_10
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												className="table-data"
												sx={{
													color: checkedFiltersTimeSpent.over_10
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												className="table-data"
												sx={{
													color: checkedFiltersTimeSpent.over_30
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
									...
									<FormControlLabel
										...
										label={
											<Typography
												className="table-data"
												sx={{
													color: checkedFiltersTimeSpent.over_60
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
					...
					>
						...
						>
							<Box
								sx={{
									...filterStyles.active_filter_dote,
									visibility: isRecurringVisitsFilterActive()
										? "visible"
										: "hidden",
								}}
							/>
						...
						<Collapse in={isRecurringVisits}>
							<Box
								sx={{ display: "flex", justifyContent: "start", gap: 2, pl: 2 }}
							>
								{["1", "2", "3", "4", "4+"].map((label) => (
									<FormControlLabel
										key={label}
										...
										label={
											<Typography
												className="table-data"
												sx={{
													color: selectedValues.includes(label)
														? "rgba(56, 152, 252, 1) !important"
														: "rgba(74, 74, 74, 1)",
												}}
											>
