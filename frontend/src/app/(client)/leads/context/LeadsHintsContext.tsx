...
const LeadsHintsContext = createContext<HintsContextType | undefined>(
	undefined,
);

export const LeadsHintsProvider: React.FC<HintsProviderProps> = ({
	children,
}) => {
	const [leadsTableHints, setLeadsTableHints] = useState<
		HintStateMap<TableKey>
	>(initialLeadsTableHints);
