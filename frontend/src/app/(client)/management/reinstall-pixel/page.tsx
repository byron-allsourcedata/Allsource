...
const ReinstallPixel: React.FC = () => {
	...
	return (
		<Box sx={{ ...managementStyle.mainContent }}>
					...
					>
						...
						>
							...
							<Typography
								...
								sx={{ textWrap: "nowrap" }}
							>
								Management - Reinstall Tracking Pixel
							</Typography>
							<CustomToolTip
								title={
			...
			{bannerVisible && (
				<Box sx={{ width: "100%", pr: 2, mb: 3 }}>
					<NotificationInfoBanner
						message={"Reinstall website pixel for troubleshooting"}
