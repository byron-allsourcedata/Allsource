...
const BingAdsDataSync: React.FC<BingAdsDataSyncProps> = ({ open, onClose, data, isEdit }) => {
                                    ...
                                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                        <Box sx={{ p: 2, border: '1px solid #f0f0f0', borderRadius: '4px', boxShadow: '0px 2px 8px 0px rgba(0, 0, 0, 0.20)' }}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px', mb: 3 }}>
                                                <Image src='/bing-ads.svg' alt='webhook' height={26} width={32} />
                                    ...
                                    <Box sx={{
                                        ...
                                        <Grid container alignItems="center" sx={{ flexWrap: { xs: 'nowrap', sm: 'wrap' }, marginBottom: '14px' }}>
                                            ...
                                            <Grid item xs="auto" sm={5} sx={{
                                                ...
                                                <Image src='/bing-ads.svg' alt='googleAds' height={20} width={24} />
                                            </Grid>
