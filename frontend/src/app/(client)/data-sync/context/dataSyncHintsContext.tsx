...
const DataSyncHintsContext = createContext<
	DataSyncHintsContextType | undefined
>(undefined);
...
export const DataSyncHintsProvider: React.FC<{ children: ReactNode }> = ({
	...
	const [hints, setHints] =
		useState<HintStateMap<DataSyncKey>>(initialDataSyncHints);
...
export const useDataSyncHints = () => {
	...
	if (!ctx)
		throw new Error("useDataSyncHints must be inside DataSyncHintsProvider");
	return ctx;
};
