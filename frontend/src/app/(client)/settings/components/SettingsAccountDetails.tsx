...
export const SettingsAccountDetails: React.FC<SettingsAccountDetailsProps> = ({
	...
	const [emailAddress, setEmailAddress] = useState(
		accountDetails.email_address,
	);
	const [organizationName, setOrganizationName] = useState(
		accountDetails.company_name,
	);
	const [companyWebsite, setCompanyWebsite] = useState(
		accountDetails.company_website,
	);
	const [monthlyVisits, setMonthlyVisits] = useState(
		accountDetails.company_website_visits,
	);
	const [resetPasswordDate, setResetPasswordDate] = useState(
		accountDetails.reset_password_sent_at,
	);
	...
	const [isOrganizationNameFocused, setIsOrganizationNameFocused] =
		useState(false);
	const [isOrganizationNameTyping, setIsOrganizationNameTyping] =
		useState(false);
	const [isOrganizationNameModified, setIsOrganizationNameModified] =
		useState(false);
	const [isOrganizationNameEditable, setIsOrganizationNameEditable] =
		useState(false);
	...
	const [isCompanyWebsiteModified, setIsCompanyWebsiteModified] =
		useState(false);
	const [isCompanyWebsiteEditable, setIsCompanyWebsiteEditable] =
		useState(false);
	...
	const handleSaveAccountDetails = (field: "full_name" | "email_address") => {
		...
		axiosInterceptorInstance
			.put("/settings/account-details", accountData)
			.then(() => {
	...
	const handleChangePassword = () => {
		...
		if (newPassword === confirmNewPassword) {
			...
			axiosInterceptorInstance
				.put("/settings/account-details", changePasswordData)
				.then((response) => {
	...
	const handleSaveBusinessInfo = (
		field: "organizationName" | "companyWebsite" | "monthlyVisits",
	) => {
		const businessInfoData = {
			business_info: {
				organization_name:
					field === "organizationName" ? organizationName : undefined,
				company_website:
					field === "companyWebsite" ? companyWebsite : undefined,
				visits_to_website:
					field === "monthlyVisits" ? monthlyVisits : undefined,
			},
		};
		axiosInterceptorInstance
			.put("/settings/account-details", businessInfoData)
			.then(() => {
				...
				<Box sx={{ display: "flex", flexDirection: "column", gap: "18px" }}>
					...
					>
						...
						<Button
							...
							variant="contained"
							color="primary"
							onClick={() => handleSaveAccountDetails("full_name")}
							sx={{
								borderRadius: "4px",
						...
						{!isEmailEditable && !isEmailTyping && (
							...
							>
								...
								accountDetails.is_email_confirmed ? (
									<>
										<Image
											src="/green-tick-circle.svg"
											alt="green-tick-circle"
											height={16}
											width={16}
										/>
										<Typography
					...
					>
						<TextField
							sx={{
								...
								"& .MuiIconButton-root": {
									display:
										isEmailEditable ||
										showCloseIcon(isTyping, emailAddress, initialEmail)
											? "none"
											: "none", // Always hidden
								},
							}}
						...
						<Button
							...
							variant="contained"
							color="primary"
							onClick={() => handleSaveAccountDetails("email_address")}
							sx={{
								borderRadius: "4px",
								border: "1px solid rgba(56, 152, 252, 1)",
								background: "#fff",
							...
							disabled={
								!isSaveEnabled(emailAddress, initialEmail, isEmailModified)
							}
						>
							Save
						</Button>
