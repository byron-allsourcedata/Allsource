...
const SourcesHintsContext = createContext<HintsContextType | undefined>(
	undefined,
);
...
export const SourcesHintsProvider: React.FC<HintsProviderProps> = ({
	...
	const [sourcesBuilderHints, setSourcesBuilderHints] = useState<
		HintStateMap<BuilderKey>
	>(initialSourcesBuilderHints);
	const [sourcesTableHints, setSourcesTableHints] = useState<
		HintStateMap<TableKey>
	>(initialSourcesTableHints);
	const [createdSourceHints, setCreatedSourceHints] = useState<
