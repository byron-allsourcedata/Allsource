		...
		>
			...
			<Box>
				...
				>
					...
					>
						We couldn’t train your model due to issues in the uploaded data. Fix
						these issues, re-upload your file, and try again.
					</Typography>
				</Box>
				...
				>
					...
					>
						...
						>
							<Button href="#" sx={popupStyle.learnMoreText}>
