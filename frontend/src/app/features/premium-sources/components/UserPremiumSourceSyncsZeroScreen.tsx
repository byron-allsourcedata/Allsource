...
export const UserPremiumSourceSyncsZeroScreen: FC<Props> = ({
	onBeginClick,
}) => {
	return (
		<Column alignItems={"center"}>
			<Column gap="1rem">
				<Header>Sync Your Premium Source</Header>
				<Subheader>Create a Sync to a platform of your choice</Subheader>
				<BannerContainer justifyContent={"start"} textAlign={"left"}>
					<BannerHeader>Sync Premium Source Any Platform</BannerHeader>
					<Image
						alt="Premium Sources Sync"
						src={"/premium_sources_syncs_zero_logo.svg"}
						width={800}
						height={300}
					/>
					<Explanation>
						Send your Premium Source to connected platforms like Meta Ads,
