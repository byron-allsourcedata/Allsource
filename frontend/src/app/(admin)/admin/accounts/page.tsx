...
const Accounts: React.FC = () => {
	...
	const [rewardsPageMonthFilter, setRewardsPageMonthFilter] = useState<
		string | null
	>(null);
	...
	const fetchRewards = async (selectedYear: string, partnerId = null) => {
		...
		try {
			const response = await axiosInstance.get(
				"/admin-partners/rewards-history",
				{
					params: {
						year: selectedYear,
	...
	const handleCloseMenu = () => {
		setMenuAnchor(null);
		setIsMaster(false), setSelectedRowData(null);
	};
	...
	const setEnabled = async () => {
		...
		try {
			const response = await axiosInstance.put(
				`admin-partners/${selectedRowData.id}/`,
				{ status: "active" },
				{
							...
							>
								...
								{rewardsPage && (
									<RewardsHistory
										...
										setFlagMounthReward={setFlagMounthReward}
										setRewardsPageMonthFilter={setRewardsPageMonthFilter}
										rewards={rewards}
																			...
																			>
																				<Typography
																					...
																					sx={{
																						...
																						fontWeight: "400",
																						lineHeight: "16px",
																						color: getStatusStyle(data.status)
																							.color,
																					}}
																				>
																					{data.status}
