...
const Slider: React.FC<SliderProps> = ({ isOpen, onClose, referralPayoutId, onSumbit }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            onSumbit()
            showToast('Success reject account reward')
        } catch {
            ...
            <Drawer anchor="right" open={isOpen} PaperProps={{
                ...
                <Box
                    ...
                    <Box
                        ...
                        >
                            Are you sure you want to reject the reward payout?
                        </Typography>

                        <TextField
                            id="outlined-required"
                            label="Enter the reason for reward payout"
                            placeholder='Enter the reason for reward payout'
                            sx={{
