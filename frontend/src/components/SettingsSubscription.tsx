...
export const SettingsSubscription: React.FC = () => {
    ...
    return (
                <Box sx={{marginBottom: '36px'}}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2, marginBottom: 2, position: 'relative',
                        '@media (max-width: 600px)': {
                    ...
                    <Box sx={{ marginTop: 4, marginBottom: '24px', borderRadius: '10px', 
