        ...
        >
            ...
            <Box sx={{padding: '30px 32px 0 32px', display: 'flex', flexDirection: 'column', gap: '32px'}}>
                ...
                renderInput={(params) => (
                    ...
                    onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                            const inputValue = (e.currentTarget as HTMLInputElement).value; // Cast to HTMLInputElement
                            handleAddEmail(inputValue);
                            (e.currentTarget as HTMLInputElement).value = ''; // Clear the input
                        }
                    }}
                ...
                renderOption={(props, option) => (
                    <MenuItem {...props} key={option} sx={{ fontFamily: 'Roboto',
                        color: '#202124',
                        fontSize: '14px',
                        lineHeight: '20px' }}>
                    {option}
