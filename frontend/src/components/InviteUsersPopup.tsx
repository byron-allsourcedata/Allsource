...
export const InviteUsersPopup: React.FC<InviteUsersPopupProps> = ({
	open,
	onClose,
	onSend,
}) => {
		...
		>
			...
			>
							...
							onKeyDown={(e) => {
								if (e.key === "Enter" && inputValue.trim()) {
									const emailExists = emails.some(
										(email) =>
											email.toLowerCase() === inputValue.trim().toLowerCase(),
									);
				...
				>
					<FormControl
						variant="outlined"
						sx={{ width: "100%", minHeight: "48px", lineHeight: "normal" }}
					>
						<InputLabel
							className="main-text"
										...
										<InputAdornment position="end">
											...
											>
												<Image
													...
													alt={
														selectOpen ? "chevron-drop-up" : "chevron-drop-down"
													}
													height={24}
													width={24}
												/>
