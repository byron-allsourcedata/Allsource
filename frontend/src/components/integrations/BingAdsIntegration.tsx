		...
		<>
			...
			>
				...
				>
					...
					>
						<Link
							href="https://allsourceio.zohodesk.com/portal/en/kb/articles/connect-to-bingads"
							target="_blank"
								...
								>
									...
									<Box>
										...
										{invalid_api_key && (
											...
											>
												Invalid API Key detected. Please reconnect to BingAds
												and try again
											</Typography>
										)}
									</Box>
