...
export { default as FirstTimeScreenCommonVariant1 } from "./FirstTimeScreenCommonVariant1";
export { default as FirstTimeScreenCommonVariant2 } from "./FirstTimeScreenCommonVariant2";
