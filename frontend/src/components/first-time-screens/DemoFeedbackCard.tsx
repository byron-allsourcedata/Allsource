		...
		>
			...
			>
				...
				<Typography
					...
					gutterBottom
				>
					A confirmation email will be sent shortly to <strong>{email}</strong>.
					Please check your inbox for a message from our team.
				</Typography>
					...
					>
						{[
							...
							<FormControlLabel
								...
								label={
									<Typography sx={labelTypographySx}>{opt.label}</Typography>
								}
							/>
						))}
					</RadioGroup>
				...
				<FormControl component="fieldset" sx={{ mb: 3 }}>
					...
					>
						Is AI-powered audience targeting part of your current marketing
						strategy?
					</Typography>
					<RadioGroup
						value={aiStrategy}
