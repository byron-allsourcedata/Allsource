...
const InvitePartnerPopup: React.FC<FormUploadPopupProps> = ({
	maxCommission,
	masterId,
	isMaster,
	open,
		...
		<>
			...
			>
				...
				>
					...
					>
						{action === "Add" ? "Invite" : "Edit"} {isMaster ? "master" : ""}{" "}
						partner details
					</Typography>
				...
				>
					...
					>
						...
						<TextField
							...
							helperText={
								commissionError
									? `Commission must be a number between 1 and ${maxCommission ?? 70}`
									: ""
							}
						/>
					</Box>
