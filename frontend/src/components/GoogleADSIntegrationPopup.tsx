...
interface CreateGoogleADSProps {
    handleClose: () => void
...
const GoogleADSIntegrationPopup = ({ handleClose, open, onSave, initApiKey, boxShadow, Invalid_api_key }: CreateGoogleADSProps) => {
...
export default GoogleADSIntegrationPopup;