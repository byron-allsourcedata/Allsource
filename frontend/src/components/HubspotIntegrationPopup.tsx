...
const HubspotIntegrationPopup = ({
	...
	const instructions = [
		...
		{
			id: "unique-id-2",
			text: "Click on the settings icon in the top navigation bar.",
		},
		{
			id: "unique-id-3",
		...
		{
			id: "unique-id-7",
			text: 'Click "Create app" and confirm your selection.',
		},
		{
			id: "unique-id-8",
		...
		{
			id: "unique-id-9",
			text: 'Click "Connect" to complete the integration process.',
		},
	];
	...
	const highlightConfig: HighlightConfig = {
		Hubspot: { color: "rgba(56, 152, 252, 1)", fontWeight: "500" },
							...
							<TabPanel value="1" sx={{ p: 0 }}>
								...
								>
									...
									>
										...
										<Tooltip
											title="Enter the API key provided by Hubspot"
											placement="right"
										>
											<Image
								...
								>
									...
									>
										...
										>
											...
											already possess. Newly added contacts in Hubspot will be
									...
									>
										...
										>
											...
											>
												By performing this action, all your Hubspot contacts
