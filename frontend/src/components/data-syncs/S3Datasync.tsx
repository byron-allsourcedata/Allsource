...
import { Row, useCustomFields } from "./pixel-sync-data/useCustomFields";
...
const S3Datasync: React.FC<ConnectS3PopupProps> = ({
	...
	const defaultRows: Row[] = [{ id: 1, type: "Email", value: "Email" }];
			...
			>
				...
				>
					<UserTip
						...
						content="S3 standard sync speed is 500 contacts per minute."
						sx={{
							width: "100%",
					...
					>
						<TabContext value={value}>
							<Box sx={{ pb: 4 }}>
								<TabList
									centered
									aria-label="Connect to Sendlane Tabs"
									TabIndicatorProps={{
