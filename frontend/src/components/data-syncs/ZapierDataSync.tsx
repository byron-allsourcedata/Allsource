...
const ZapierDataSync = ({ handleClose, open }: CreateKlaviyoProps) => {
	...
	const instructions = [
		{
			id: "unique-id-1",
			text: "Go to the Zapier website and log into your account.",
		},
		{
			id: "unique-id-2",
			text: "Click on the Zap option located in your Zapier account options.",
		},
		{ id: "unique-id-3", text: "Click Create New Zap" },
		{
			id: "unique-id-4",
			text: "Configure the new Zap according to the instructions",
		},
			...
			>
				...
				>
					<UserTip
						...
						content="Zapier standard sync speed is 150 contacts per minute."
						sx={{
							width: "100%",
					...
					<Box
						sx={{ px: 2, py: 3.5, width: "100%", border: "1px solid #e4e4e4" }}
					>
						<Box
							sx={{
								width: "100%",
