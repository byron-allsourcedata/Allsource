...
const AttentiveIntegrationPopup = ({ handleClose, open, onSave, initApiKey, isEdit, boxShadow, invalid_api_key}: CreateAttentiveProps) => {
    ...
    const instructions = [
        { id: 'unique-id-1', text: 'Go to the Attentive website and log into your account.' },
        { id: 'unique-id-2', text: 'Click on the Settings option located in your Attentive account options.' },
        { id: 'unique-id-3', text: 'Click Create Private API Key Name to Maximiz.' },
        { id: 'unique-id-4', text: 'Assign full access permissions to Lists and Profiles, and read access permissions to Metrics, Events, and Templates for your Attentive key.' },
        { id: 'unique-id-5', text: 'Click Create.' },
        { id: 'unique-id-6', text: 'Copy the API key in the next screen and paste to API Key field located in Maximiz Attentive section.' },
    ...
    const highlightConfig: HighlightConfig = {
        'Attentive': { color: '#5052B2', fontWeight: '500' }, 
        ...
        >
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', height: '100%' }}>
                ...
                <TabContext value={value}>
                    <Box sx={{pb: 4}}>
                        <TabList centered aria-label="Connect to Attentive Tabs"
                        ...
                        <Tab label="API Key" value="1" sx={{...attentiveStyles.tabHeading, cursor: 'pointer'}} />
                        <Tab label="Suppression Sync" value="2" sx={attentiveStyles.tabHeading} />
                        </TabList>
                    </Box>
                    <TabPanel value="1" sx={{p: 0}}>
                        <Box sx={{ p: 2, border: '1px solid #f0f0f0', borderRadius: '4px', boxShadow: '0px 2px 8px 0px rgba(0, 0, 0, 0.20)' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                ...
                                <Tooltip title="Enter the API key provided by Attentive" placement="right">
                        ...
                        <Box sx={{ background: '#f0f0f0', border: '1px solid #efefef', borderRadius: '4px', p: 2 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px', mb: 2 }}>
                                ...
                                <Typography variant="subtitle1" sx={{
                                    ...
                                    color: '#202124',
                                    lineHeight: 'normal'
                                }}>How to integrate Attentive</Typography>
                            </Box>
                            <List dense sx={{ p: 0 }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <Box sx={{ p: 2, border: '1px solid #f0f0f0', borderRadius: '4px', boxShadow: '0px 2px 8px 0px rgba(0, 0, 0, 0.20)', display: 'flex', flexDirection:'column', gap: '16px' }}>
                                ...
                                <Typography variant="subtitle1" sx={{
                                    ...
                                    Newly added contacts in Attentive will be automatically suppressed each day.</Typography>
                            ...
                            <Box sx={{ background: '#efefef', borderRadius: '4px', px: 1.5, py: 1 }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    ...
                                    <Typography variant="subtitle1" sx={{
                                        ...
                                        lineHeight: '20px',
                                        letterSpacing: '0.06px'
                                    }}>By performing this action, all your Attentive contacts will be added to your Grow suppression list, and new contacts will be imported daily around 6pm EST.</Typography>
                                </Box>
                            </Box>
                        </Box>
                    </TabPanel>
