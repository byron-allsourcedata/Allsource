...
const PartnersAdmin: React.FC<PartnersAdminProps> = ({
	masterData,
	setMasterData,
	isMaster: master,
	tabIndex,
	...
	const setEnabled = async () => {
		...
		try {
			const response = await axiosInstance.put(
				`admin-partners/opportunity/${selectedRowData.id}/`,
				{ status: true },
				{
	...
	return (
		...
		>
			...
			{accountPage && (
				<PartnersAccounts id={id} setLoading={setLoading} loading={loading} />
			)}
