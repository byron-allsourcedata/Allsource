	...
	return (
		<Box
			sx={{
				...
				gap: "8px",
				position:
					asset.type === "image" || "presentation" ? "relative" : "static",
				overflow:
					asset.type === "image" || "presentation" ? "hidden" : "visible",
		...
		>
				...
				{!isAdmin && (
					...
					>
						<IconButton
							...
							sx={{ width: "12.84px", height: "10.96px" }}
						>
							{asset.isFavorite ? (
								<FavoriteIcon
									sx={{
			...
			>
				...
				>
					...
					>
						<ListItemButton
							sx={{ ":hover": { backgroundColor: "rgba(80, 82, 178, 0.1)" } }}
							onClick={() => {
								handleDeleteAsset();
								handleCloseMenu();
							}}
