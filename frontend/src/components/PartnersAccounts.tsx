...
const PartnersAccounts: React.FC<PartnersAccountsProps> = ({
	...
	}>(appliedDatesFromMain ?? { start: null, end: null });
	...
	useEffect(() => {
		if (
			appliedDatesFromMain?.start instanceof Date ||
			(appliedDatesFromMain?.start === null &&
				appliedDatesFromMain?.end instanceof Date) ||
			appliedDatesFromMain?.end === null
		) {
												...
												<Box sx={{ display: "flex", justifyContent: "center" }}>
													<Typography
														...
														sx={{
															width: "74px",
															margin: "0",
															background: getStatusStyle(data.reward_status)
																.background,
															padding: "3px 8px",
															borderRadius: "2px",
															fontFamily: "var(--font-roboto)",
												...
												<Box sx={{ display: "flex", justifyContent: "center" }}>
													<Typography
														...
														sx={{
															width: "100px",
															margin: "0",
															background: getStatusStyle(data.status)
																.background,
															padding: "3px 8px",
															borderRadius: "2px",
															fontFamily: "var(--font-roboto)",
