			...
			>
				...
				>
					<img
						...
						alt="Setup"
						style={{ width: "40%", marginBottom: "3rem", marginTop: "2rem" }}
					/>
					{prefillData && prefillData.email ? (
						<>
							...
							>
								Don&apos;t miss out on getting started! Schedule a call with our
								onboarding specialist now.
							</Typography>
							<Typography
								variant="body1"
								className="second-sub-title"
							...
							>
								<Button onClick={handleClose} sx={{ width: "100%" }}>
									<PopupButton
										...
										url={meetingUrl}
										rootElement={
											document.getElementById("calendly-popup-wrapper")!
										}
						...
						<>
							...
							>
								...
								>
									To activate your Free Trial, speak to one of our onboarding
									specialists, and we&apos;ll get you started.
								</Typography>
								<Box
									sx={{
										display: "flex",
								...
								>
									...
									<Box
										sx={{ display: "flex", justifyContent: "start", pl: 4.5 }}
									>
										<Typography
								...
								>
									...
									>
										...
										>
											Within a few days start watching the sales and revenue
											from your account.
										</Typography>
									</Box>
								</Box>
