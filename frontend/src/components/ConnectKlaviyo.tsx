...
const ConnectKlaviyo: React.FC<ConnectKlaviyoPopupProps> = ({ open, onClose, data }) => {
    ...
    return (
        ...
        >
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', py: 2.85, px: 2, borderBottom: '0ю5px solid #e4e4e4', position: 'sticky', top: 0, zIndex: '9', backgroundColor: '#fff' }}>
