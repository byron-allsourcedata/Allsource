...
const LinkedinConnectPopup = ({ open, handlePopupClose, boxShadow, invalid_api_key }: LinkedinConnectProps) => {
                    ...
                    <TabContext value={value}>
                        <Box sx={{ pb: 4 }}>
                            <TabList centered aria-label="Connect to Slack Tabs"
                                ...
                                <Tab label="Connection" value="1" className='tab-heading' sx={linkedinStyles.tabHeading} onClick={() => setValue('1')} />
                            </TabList>
                        </Box>
                            ...
                            <Box sx={{ p: 2, border: '1px solid #f0f0f0', borderRadius: '4px', boxShadow: '0px 2px 8px 0px rgba(0, 0, 0, 0.20)' }}>
                                ...
                                <Box>
                                    <Button
                                        ...
                                        onClick={handleLogin}
                                        variant="contained"
                                        startIcon={<Image src='/linkedin-icon.svg' alt='linkedin' height={24} width={24} />}
                                        sx={{
