...
const AlivbleIntagrationsSlider = ({
	open,
	isContactSync = false,
	integrations,
	...
	onClose,
	handleSaveSettings,
}: AvailableIntegrationsSliderProps) => {
	...
	return (
		<>
						...
						>
							...
							>
								{filteredIntegrations.some(
									(integration) => integration.service_name === "wordpress",
								) &&
								...
								{/* {filteredIntegrations.some(
									...
									!integrationsCredentials.some(
										...
										>
											<ListItemButton
												onClick={() => setOpenBingAdsConnect(true)}
												sx={{
													p: 0,
													flexDirection: "column",
													px: 3,
								...
								{filteredIntegrations.some(
									...
									!integrationsCredentials.some(
										...
										>
											<ListItemButton
												onClick={() => setAttentiveConnect(true)}
												sx={{
													p: 0,
													flexDirection: "column",
													px: 3,
								...
								{filteredIntegrations.some(
									...
									!isContactSync && (
										...
										>
											<ListItemButton
												onClick={() => setOpenShopifyConnect(true)}
												sx={{
													p: 0,
													flexDirection: "column",
													px: 3,
								...
								{filteredIntegrations.some(
									(integration) => integration.service_name === "elastic",
								) &&
									!integrationsCredentials.some(
										(integration) => integration.service_name === "elastic",
									) && (
								...
								{filteredIntegrations.some(
									...
									!integrationsCredentials.some(
										...
										>
											<ListItemButton
												onClick={() => setOpenSendlaneConnect(true)}
												sx={{
													p: 0,
													flexDirection: "column",
													px: 3,
								...
								{filteredIntegrations.some(
									...
									!integrationsCredentials.some(
										...
										>
											<ListItemButton
												onClick={() => setOpenLinkedInConnect(true)}
												sx={{
													p: 0,
													flexDirection: "column",
													px: 3,
			...
			<OmnisendConnect
				...
				handleClose={() => setOpenOmnisendConnect(false)}
				onSave={saveIntegration}
			/>
			<MailchimpConnect
				open={openMailchimpConnect}
				handleClose={() => setOpenMailchimpConnect(false)}
				onSave={saveIntegration}
			/>
			<S3Connect
				open={openS3Connect}
				handleClose={() => setOpenS3Connect(false)}
				onSave={saveIntegration}
			/>
			<SendlaneConnect
			...
			<SlackConnectPopup
				...
				handlePopupClose={() => setOpenSlackConnect(false)}
				onSave={saveIntegration}
			/>
			...
			<LinkedinConnectPopup
				...
				handlePopupClose={() => setOpenLinkedInConnect(false)}
				onSave={saveIntegration}
			/>
			<SalesForceIntegrationPopup
				open={openSalesForceConnect}
				handleClose={() => setOpenSalesForceConnect(false)}
				onSave={saveIntegration}
			/>
			<WebhookConnectPopup
				open={openWebhookConnect}
				handleClose={() => setOpenWebhookConnect(false)}
				onSave={saveIntegration}
			/>
		</>
	);
