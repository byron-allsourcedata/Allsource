                    ...
                    <TabPanel value="1" sx={{p: 0}}>
                        ...
                        {instructions.length > 0 && ( <Box sx={{ background: '#f0f0f0', border: '1px solid #efefef', borderRadius: '4px', p: 2 }}>
                                ...
                                <Typography variant="subtitle1" sx={{
                                    ...
                                    color: '#202124',
                                    lineHeight: 'normal'
                                }}>How to integrate Omnisend</Typography>
                            </Box>
                            <List dense sx={{ p: 0 }}>
                            ...
                            <Box sx={{ background: '#efefef', borderRadius: '4px', px: 1.5, py: 1 }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    ...
                                    <Typography variant="subtitle1" sx={{
                                        ...
                                        lineHeight: '20px',
                                        letterSpacing: '0.06px'
                                    }}>By performing this action, all your Omnisend contacts will be added to your Grow suppression list, and new contacts will be imported daily around 6pm EST.</Typography>
                                </Box>
                            </Box>
                        </Box>
                    </TabPanel>
