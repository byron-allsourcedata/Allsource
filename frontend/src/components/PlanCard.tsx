        ...
        <Box sx={{
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 2 }}>
                ...
                <Typography variant="h4" component="div" className='heading-text' sx={{ fontSize: '24px !important', fontWeight: '600 !important', textAlign: 'center' }}>
                    <Typography variant="h6" component="sup" className='third-sub-title' sx={{ letterSpacing: '0.06px' }}>$</Typography>{plan.price} <Typography variant="h6" component="span" className='paragraph' sx={{ marginLeft: '-4px' }}>{plan.interval === 'month' ? '/month' : '/year'}</Typography>
                </Typography>
            </Box>
