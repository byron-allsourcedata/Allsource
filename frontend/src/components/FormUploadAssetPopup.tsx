...
const FormUploadAssetPopup: React.FC<FormUploadPopupProps> = ({
	updateOrAddAsset,
	fileData,
	open,
	onClose,
	...
	const [actionType, setActionType] =
		useState<keyof typeof allowedExtensions>("video");
	...
	const handleSubmit = async () => {
		...
		try {
			...
			if (response.data.status === "SUCCESS") {
				updateOrAddAsset(response.data.data.type, {
					...response.data.data,
					isFavorite: false,
				});
