			...
			>
				...
				>
								...
								>
									{lead.mobile_phone || lead.personal_phone ? (
										...
										>
											...
											/>
											{lead.mobile_phone
												? lead.mobile_phone.split(",")[0]
												: lead.personal_phone
													? lead.personal_phone.split(",")[0]
													: "--"}
										</Link>
									) : (
										<>
					...
					<Box sx={accountStyles.box_param}>
						...
						<Box sx={accountStyles.rows_pam}>
							<Typography sx={{ ...accountStyles.title_text }}>Zip:</Typography>
							<Typography sx={{ ...accountStyles.text }}>
								{lead.personal_zip ? `${lead.personal_zip || ""}`.trim() : "--"}
							</Typography>
						</Box>
					...
					<Box sx={accountStyles.box_param}>
						...
						{lead.page_visits?.map((page_visit: any, index: number) => {
							const trimmedPage = page_visit.page.startsWith("http")
								? page_visit.page
								: `https://${page_visit.page}`;
							...
							return (
								<Box
									...
									sx={{
										...
										display: "flex",
										borderBottom:
											index === lead.page_visits.length - 1
												? "none"
					...
					<Box sx={accountStyles.box_param}>
						...
						<Box sx={accountStyles.rows_pam}>
							...
							<Typography sx={{ ...accountStyles.text }}>
								{lead.age_min && lead.age_max
									? `${lead.age_min} - ${lead.age_max} yrs `
									: "--"}
							</Typography>
						</Box>
					...
					<Box sx={accountStyles.box_param}>
						...
						<Box sx={{ ...accountStyles.rows_pam, borderBottom: "none" }}>
							...
							<Typography
								component="div"
								sx={{ ...accountStyles.text, color: "rgba(56, 152, 252, 1)" }}
							>
