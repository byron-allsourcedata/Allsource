...
CampaignNotFound = HTTPException(
    status_code=status.HTTP_404_NOT_FOUND, detail="Campaign Not Found"
)
CreatorNotUser = HTTPException(
...
ScheduleNotFound = HTTPException(
    status_code=status.HTTP_404_NOT_FOUND, detail="Schedule Not Found"
)
SequenceNotFound = HTTPException(
    status_code=status.HTTP_404_NOT_FOUND, detail="Sequence Not Found"
)
StepNotFound = HTTPException(
...
UserNotCreator = HTTPException(
    status_code=status.HTTP_403_FORBIDDEN, detail="Invalid Token"
)
UserNotFound = HTTPException(
    status_code=status.HTTP_404_NOT_FOUND, detail="User Not Found"
)
UserNotOwner = HTTPException(
    status_code=status.HTTP_403_FORBIDDEN, detail="User is not owner"
)
UserCreditLimitExceeded = HTTPException(
    status_code=status.HTTP_403_FORBIDDEN, detail="credit limit is exceeded"
)
NameAlreadyExists = HTTPException(
    status_code=status.HTTP_400_BAD_REQUEST, detail="Same name already exists"
)
