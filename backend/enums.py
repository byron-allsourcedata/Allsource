...
class SendgridTemplate(Enum):
    ...
    SEND_VIEW_PRODUCT_PIXEL_TEMPLATE = "send_view_product_pixel"
    SEND_ADD_TO_CART_PIXEL_TEMPLATE = "send_add_to_cart_pixel"
    SEND_CONVERTED_SALE_PIXEL_TEMPLATE = "send_converted_sale_pixel"
