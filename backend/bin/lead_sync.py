...
from enums import NotificationTitles, AliasPlanName
    ...
    if current_visit_request:
        ...
        if is_first_request == True:
            ...
            if len(lead_users) == 1:
                ...
                if subscription_result['is_artificial_status'] and not subscription_result['subscription'].plan_end and subscription_result['alias'] != AliasPlanName.INFINITE.value:
