...
from models.five_x_five_interests import FiveXFiveInterests

load_dotenv()
FILE_PATH = os.path.join(os.path.dirname(__file__), '..', 'tmp', 'Behavioral Counts.xlsx')
...
def check_and_print_excel(session):
    ...
    if required_columns.issubset(actual_columns):
        ...
        for index, row in filtered_df.iterrows():
            five_x_five_interests = insert(FiveXFiveInterests).values(
