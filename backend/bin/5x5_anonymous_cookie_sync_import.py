...
FILES_PATH = "outgoing/cookie_sync/unresolved"
LAST_PROCESSED_FILE_PATH = "tmp/last_processed_5x5_anonymous_cookie_sync.txt"
...
async def save_files_for_db(table, session, file_key):
    for i in range(len(table)):
        ...
        five_x_five_cookie_sync_file = (
            insert(FiveXFiveAnonymousCookieSync)
            .values(
