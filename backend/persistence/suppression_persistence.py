...
class SuppressionPersistence:
    ...
    def get_suppression_list(self, page, per_page, domain_id: int):
    ...
    def delete_suppression_list(self, suppression_list_id, domain_id: int):
    ...
    def get_suppression_list_by_id(self, suppression_list_id, domain_id: int):
        suppression_lists = (
            self.db.query(SuppressionList)
            .filter(
                SuppressionList.domain_id == domain_id,
    ...
    def get_rules(self, domain_id):
        rules = (
            self.db.query(SuppressionRule)
            .filter(SuppressionRule.domain_id == domain_id)
            .first()
        )
        return rules

    def create_suppression_rule(self, domain_id: int):
    ...
    def process_delete_contacts(self, domain_id: int):
        ...
        if rules.is_delete_contacts == False:
            ...
            rules.is_delete_contacts = False
        self.db.commit()
