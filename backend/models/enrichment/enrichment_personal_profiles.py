...
class EnrichmentPersonalProfiles(Base):
    ...
    birth_month: Mapped[int] = mapped_column(SmallInteger, nullable=True)
    birth_year: Mapped[int] = mapped_column(SmallInteger, nullable=True)
    has_children: Mapped[int] = mapped_column(SmallInteger, nullable=False)
    number_of_children: Mapped[int] = mapped_column(SmallInteger, nullable=True)
    religion: Mapped[str] = mapped_column(String(10), nullable=True)
    ethnicity: Mapped[str] = mapped_column(String(10), nullable=True)
    language_code: Mapped[str] = mapped_column(String(10), nullable=True)
    state_abbr: Mapped[str] = mapped_column(String(10), nullable=True)
