...
class PremiumSourceFundsDeduction(Base):
    """
    Represents the funds deduction for a premium source.
    Its a part of transaction
    """

    __tablename__ = "premium_sources_deduction_funds"
...
event.listen(PremiumSourceFundsDeduction, "before_update", update_timestamps)
