...
class AudienceSourcesMatchedPerson(Base):
    ...
    inverted_recency = Column(DECIMAL(20, 5), default=0)
    inverted_recency_min = Column(DECIMAL(20, 5), default=0)
    inverted_recency_max = Column(DECIMAL(20, 5), default=0)
    duration = Column(DECIMAL(20, 5), default=0)
    recency_score = Column(DECIMAL(20, 5), default=0)
    view_score = Column(DECIMAL(20, 5), default=0)
    value_score = Column(DECIMAL(20, 5), default=0)
    ...
    sum_score = Column(DECIMAL(20, 5), default=0)
