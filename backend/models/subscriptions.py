...
class UserSubscriptions(Base):
    ...
    id = Column(
        BigInteger,
        Sequence("user_subscriptions_id_seq", metadata=Base.metadata),
        primary_key=True,
        nullable=False,
    )
    ...
    is_trial = Column(Boolean, nullable=True, server_default=text("false"))
    ...
    members_limit = Column(BigInteger, nullable=True)
