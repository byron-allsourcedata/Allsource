...
def get_partner_accounts(
    ...
    accounts = get_accounts_service.get_partner_by_id_accounts(
        id, search, start_date, end_date, page, rows_per_page, order_by, order
    )
...
def get_accounts(
    ...
    accounts = get_accounts_service.get_admin_accounts(
        search, start_date, end_date, page, rows_per_page, order_by, order
    )
