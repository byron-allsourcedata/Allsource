...
def get_rewards_info(
    ...
    return referral_service.get_rewards_info(
        year=year, month=month, company_name=company_name
    )
...
def get_referral_details(
    ...
    if discount_code_id:
        return referral_service.get_referral_discount_code_by_id(
            discount_code_id=discount_code_id, user=user
        )
