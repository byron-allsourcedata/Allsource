...
async def update_payment_confirmation(
    ...
    result_update_subscription = webhook_service.update_subscription_confirmation(
        payload=payload
    )
...
async def update_payment_confirmation(
    ...
    payload = await request.json()
    result_update_subscription = webhook_service.cancel_subscription_confirmation(
        payload=payload
    )
    if (
        ...
        try:
            ...
            await publish_rabbitmq_message(
                ...
                message_body={
                    ...
                    "notification_id": result_update_subscription["message_body"][
                        "notification_id"
                    ],
                },
            )
            ...
            await publish_rabbitmq_message(
                ...
                message_body={
                    ...
                    "invoice_number": result_update_subscription["message_body"][
                        "invoice_number"
                    ],
