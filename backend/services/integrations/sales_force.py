...
from persistence.integrations.sale_force import SalesForcePersistence
...
class SalesForceIntegrationsService:
    ...
    def get_profile(self, domain_id: int, fields: List[ContactFiled], date_last_sync: str = None) -> List[
        ContactSuppression]:
    ...
    def __mapped_sales_force_profile(
        ...
        main_email, main_phone = resolve_main_email_and_phone(
            enrichment_contacts=contacts, validations=validations, target_schema=target_schema,
