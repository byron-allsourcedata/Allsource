...
class IntegrationService:
    ...
    def get_all_audience_sync(self, user: dict, service_name: str = None, integrations_users_sync_id: int = None):
        return self.integrations_user_sync_persistence \
            .get_all_audience_sync(
    ...
    def get_leads_for_zapier(self, domain):
        ...
        for five_x_five_user in five_x_five_users:
            ...
            location = {
                ...
                "region": getattr(five_x_five_user, 'personal_state') or getattr(five_x_five_user, 'company_state',
                                                                                 None),
    ...
    def __enter__(self):
        ...
        self.zapier = ZapierIntegrationService(self.lead_persistence, self.domain_persistence,
                                               self.integrations_user_sync_persistence, self.integration_persistence,
                                               self.client,
                                               self.million_verifier_integrations)
        self.webhook = WebhookIntegrationService(self.lead_persistence, self.domain_persistence,
                                                 self.integrations_user_sync_persistence, self.integration_persistence,
                                                 self.client,
                                                 self.million_verifier_integrations)
