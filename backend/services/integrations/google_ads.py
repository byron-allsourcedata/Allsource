...
class GoogleAdsIntegrationsService:
    ...
    def __save_integrations(self, access_token: str, refresh_token, domain_id: int, user: dict):
    ...
    def add_integration(self, credentials: IntegrationCredentials, domain, user: dict):
        ...
        integrations = self.__save_integrations(access_token, refresh_token, domain.id, user)
        return {
