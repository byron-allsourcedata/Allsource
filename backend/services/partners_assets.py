...
class PartnersAssetService:
    ...
    def get_assets(self):
        try:
            ...
            return {
                ...
                "error": {
                    "code": 500,
                    "message": f"Unexpected error during getting: {str(e)}",
                },
            }
    ...
    async def update_asset(
        ...
        try:
            updated_data = self.partners_asset_persistence.update_asset(
                asset_id, updating_data
            )
            ...
            return {
                "status": PartnersAssetsInfoEnum.SUCCESS,
                "data": self.domain_mapped(updated_data),
            }
        except Exception as e:
    ...
    async def create_asset(self, description: str, type: str, file: UploadFile = None):
        ...
        try:
            ...
            return {
                "status": PartnersAssetsInfoEnum.SUCCESS,
                "data": self.domain_mapped(created_data),
            }
        except Exception as e:
    ...
    async def generate_preview(
        self, file_contents: bytes, file_extension: str, type_asset: str
    ) -> Union[BytesIO, None]:
        try:
